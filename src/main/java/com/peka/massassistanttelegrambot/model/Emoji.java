...
public enum Emoji {
  ...
  CALC_DOWN(EmojiParser.parseToUnicode(":chart_with_downwards_trend:")),
  CALC_NORMAL(EmojiParser.parseToUnicode(":left_right_arrow:")),
  CALC_UP(EmojiParser.parseToUnicode(":chart_with_upwards_trend:")),
